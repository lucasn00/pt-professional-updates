...
FEEDS = {
    ...
    "📋 Clinical Guidelines & Scope of Practice": [
        "https://pubmed.ncbi.nlm.nih.gov/rss/search/?term=physical+therapy+clinical+guidelines&format=rss&limit=5",
        "https://pubmed.ncbi.nlm.nih.gov/rss/search/?term=physical+therapist+assistant+scope+practice&format=rss&limit=5",
    ],
    "🏃 Return to Sport": [
        "https://pubmed.ncbi.nlm.nih.gov/rss/search/?term=return+to+sport+physical+therapy&format=rss&limit=5",
    ],
    "🧠 Pain Science & Pain Neuroscience": [
        "https://pubmed.ncbi.nlm.nih.gov/rss/search/?term=pain+neuroscience+education+physical+therapy&format=rss&limit=5",
    ],
    "🤖 AI in Physical Therapy": [
        "https://pubmed.ncbi.nlm.nih.gov/rss/search/?term=artificial+intelligence+physical+therapy&format=rss&limit=5",
    ],
    "💉 Dry Needling": [
        "https://pubmed.ncbi.nlm.nih.gov/rss/search/?term=dry+needling+physical+therapy&format=rss&limit=5",
    ],
    "📊 Evidence-Based Outcome Measures": [
        "https://pubmed.ncbi.nlm.nih.gov/rss/search/?term=outcome+measures+physical+therapy+evidence+based&format=rss&limit=5",
    ],
    "🙌 Manual Therapy": [
        "https://pubmed.ncbi.nlm.nih.gov/rss/search/?term=manual+therapy+physical+therapy+randomized&format=rss&limit=5",
    ],
    "💪 Blood Flow Restriction (BFR)": [
        "https://pubmed.ncbi.nlm.nih.gov/rss/search/?term=blood+flow+restriction+training+rehabilitation&format=rss&limit=5",
    ],
}
...
def build_message(all_items: dict) -> str:
    ...
    if not any_content:
        lines.append("_No new updates found this week. Check back next Monday!_\n")
